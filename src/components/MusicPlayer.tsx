  ...
  return (
    ...
    <div className="flex items-center gap-2 flex-grow w-full md:w-auto">
      ...
      <input
        ...
        value={currentTime}
        onChange={handleSeek}
        className="flex-grow h-2 bg-gray-100 dark:bg-gray-600 rounded-full appearance-none cursor-pointer accent-mizu-dark dark:accent-mizu-light disabled:opacity-50 disabled:cursor-not-allowed" // Basic styling + accent color
    ...
    <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="w-16 md:w-20 h-1 bg-gray-50 dark:bg-gray-600 rounded-full appearance-none cursor-pointer accent-mizu-dark dark:accent-mizu-light disabled:opacity-50 disabled:cursor-not-allowed" // Shorter slider for volume
            disabled={!isMetadataLoaded}
            aria-label="Volume"
          />
    </div>
